...
const ExpenseMonthlyChart = ({ data }) => {
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-white p-4 shadow-md rounded-lg border border-zinc-200">
    ...
    <div>
      {data.length === 0 ? (
        <div className="text-center py-12 text-zinc-500 bg-zinc-50 rounded-lg border border-zinc-200">
          <svg className="w-12 h-12 mx-auto text-zinc-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-zinc-50 p-4 rounded-xl border border-zinc-200">
              <p className="text-sm text-zinc-500 mb-1">Highest Month</p>
            ...
            <div className="bg-zinc-50 p-4 rounded-xl border border-zinc-200">
              <p className="text-sm text-zinc-500 mb-1">Lowest Month</p>
              <p className="text-lg font-semibold">
            ...
            <div className="bg-zinc-50 p-4 rounded-xl border border-zinc-200">
              <p className="text-sm text-zinc-500 mb-1">Monthly Average</p>
              <p className="text-lg font-semibold">
